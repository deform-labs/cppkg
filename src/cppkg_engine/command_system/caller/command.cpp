...
int command_system::run_quiet(const std::string& command) {
    #ifdef _WIN32
...
/// mom heard us!
std::string command_system::run_with_output(const std::string& command) {
    #ifdef _WIN32
...
/// i cant find it!
bool command_system::command_exists(const std::string& command) {
    #ifdef _WIN32
