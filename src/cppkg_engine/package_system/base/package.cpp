...
void HandlePackage::create_package(const std::string& name) {
    ...
    if (in_workspace) {
        try {
            auto toml = toml_.parse_toml("cppkg.toml");
    ...
    if (in_workspace) {
        ...
        std::cout << ux::color::cyan << "Added to workspace: " << name << ux::color::reset << "\n";
    }

    std::cout << ux::color::green << "Created package: " << name << ux::color::reset << "\n";
}
...
void HandlePackage::create_workspace(const std::string& name) {
    ...
    std::cout << ux::color::green << "Created workspace: " << name << ux::color::reset << "\n";
}
...
void HandlePackage::add_dependency(const std::string& package) {
    ...
    std::cout << ux::color::green << "Added: " << pkg_name << " @ " << version << ux::color::reset << "\n";
}
...
void HandlePackage::remove_dependency(const std::string& package) {
    ...
    std::cout << ux::color::green << "Removed: " << pkg_name << ux::color::reset << "\n";
}
